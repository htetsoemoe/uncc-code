...
server.on("connection", (socket) => {
    ...
    // We will initialize these variables when we receive the first data from every client, because we need to know the file name before creating the file handle and the write stream
